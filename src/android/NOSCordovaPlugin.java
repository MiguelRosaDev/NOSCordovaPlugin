 ...
 */
public class NOSCordovaPlugin extends CordovaPlugin {
        ...
        try{
            ...
            */
            ...
            if (action.equals("showExternalWebView") && args != null) {
                ...
                this.showExternalWebView(logging, url, title, headers, color, callbackSuccess, callbackContext, NOSPluginRequestCode, false, RequestType.OTHER.label, showBottomBar, buttonsAlignment);
                return true;
                ...
                if (packageName != null && packageName.contains("chrome")) {
                    ...
                    */
                    ...
                    this.showExternalWebView(logging, url, title, headers, color, callbackSuccess, callbackContext, INTERNAL_WEBVIEW_CODE, forceLogin, requestTypeStr, showBottomBar, buttonsAlignment);
                    return true;
                }
    ...
    */
    ...
    private void showExternalWebView(boolean logging, String url, String title, String headers, String color, String callbackSuccess, CallbackContext callbackContext, int requestCode, boolean clearCache, String requestType, boolean showBottomBar, String buttonsAlignment) {
